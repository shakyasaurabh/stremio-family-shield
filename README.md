...
## ✨ Features
* **Instant Visibility:** Displays a clean Stream Tile with the maturity rating (G, PG-13, R, etc.) before you click a stream.
* **Content Profiling:** Scans TMDb keywords to warn about specific hazards (Violence, Nudity/Sexual Content, Strong Language).
* **Zero Clutter:** Does NOT overwrite standard Cinemeta posters or descriptions, preventing library syncing issues.
